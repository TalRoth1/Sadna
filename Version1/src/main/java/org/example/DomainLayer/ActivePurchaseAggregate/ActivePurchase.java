...
public class ActivePurchase
{
    ...
    {
        this(userID, eventID, ticketIDPrices, endTime, 10.0f);
    }

    public ActivePurchase(UUID userID, UUID eventID, Map<UUID, Float> ticketIDPrices, LocalDateTime endTime, float maxWaitTime)
    {
